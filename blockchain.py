...
class Blockchain:
    ...
    def get_balance(self, sender=None):
        ...
        amount_received = reduce(lambda tx_sum, tx_amt:
                                 tx_sum + sum(tx_amt)
                                 if len(tx_amt) > 0
                                 else tx_sum + 0,
                                 tx_recipient, 0)
    ...
    def mine_block(self):
        ...
        if self.public_key is None:
            return None
        last_block = self.__chain[-1]
        # Hash the last block (=> to be able to
        # compare it to the stored hash value)
        ...
        for node in self.__peer_nodes:
            ...
            try:
                ...
                if response.status_code == 400 or response.status_code == 500:
                    print("Block was declined. This needs resolving!")
            ...
            for opentx in stored_transactions:
                if (opentx.sender == itx["sender"] and
                    ...
                    try:
                        ...
                        print("This item was already removed!")
        self.save_data()
        return True
    ...
    def resolve(self):
        ...
        longer valid ones."""
        # Initialize the winning chain with the local chain
        ...
        for node in self.__peer_nodes:
            ...
            try:
                ...
                local_chain_length = len(winning_chain)
